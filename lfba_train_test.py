...
from src.backdoorAttacks.lfba import poison_train_loader_lfba, poison_val2_loader_lfba
...
if __name__ == "__main__":
    ...
    for name, path in dataset_paths.items():
        ...
        poison_train_loader_lfba(train_loader, poison_ratio=0.5)
        poison_val2_loader_lfba(backdoor_test_loader)
