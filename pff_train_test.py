...
from src.backdoorAttacks.pff import poison_train_loader_pff, poison_val2_loader_pff
...
if __name__ == "__main__":
    ...
    for name, path in dataset_paths.items():
        ...
        poison_train_loader_pff(train_loader, poison_ratio=0.5)
        poison_val2_loader_pff(backdoor_test_loader)
