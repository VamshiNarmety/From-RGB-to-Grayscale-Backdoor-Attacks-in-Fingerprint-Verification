...
from src.backdoorAttacks.WaNet import poison_train_loader_wanet, poison_val2_loader_wanet
...
if __name__ == "__main__":
    ...
    for name, path in dataset_paths.items():
        ...
        poison_train_loader_wanet(train_loader, poison_ratio=0.5)
        poison_val2_loader_wanet(backdoor_test_loader)
